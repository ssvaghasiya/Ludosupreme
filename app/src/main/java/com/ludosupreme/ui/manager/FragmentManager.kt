...
constructor(
    ...
    override fun clearTillThisFragment(tag: String?) {
        for (i in fragmentManager.backStackEntryCount - 1 downTo 0) {
            clearThisFragmentHistory(fragmentManager.getBackStackEntryAt(i).name)
        }
    }

    override fun clearThisFragmentHistory(tag: String?) {
